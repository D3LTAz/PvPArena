...
**New pack found 2026-09-10 — [Fab: "Low Poly Weapons Set" by MR POLY](https://www.fab.com/listings/47827bc6-d20b-4567-b6e1-4650f5bc8057).** Pulled into the Fab cache (not yet imported into the project). Original/generic design — Tactical Pistol, Assault Rifle, Pump Shotgun, no reference to any specific commercial game (checked the listing's own description/tags for the same IP-risk pattern that caught the CS2/CS:GO Printstream and PREY Shotgun listings — clean). Separate triggers/magazines per weapon, multiple color variants, ships as `.glb` (also `.fbx`/`.obj`/Unreal native/Unity listed as available formats). Rig status not yet confirmed in-engine — check before treating as drop-in, same as every other free pick on this list.
